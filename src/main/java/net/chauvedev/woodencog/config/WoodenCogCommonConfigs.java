...
public class WoodenCogCommonConfigs {
    ...
    static {
        ...
        addDensityConfig("allthemodium",20000,1500);
        ...
        addDensityConfig("blue_alloy",4000,300);
        ...
        addDensityConfig("conductive_alloy",2900,600);
        ...
        addDensityConfig("darmstadtium",26500,130);
        addDensityConfig("duranium",2800,897);
        addDensityConfig("electrum",2900,700);
        addDensityConfig("end_steel",6700,530);
        addDensityConfig("enderium",3000,100);
        addDensityConfig("energetic_alloy",2700,500);
        addDensityConfig("enriched_naquadah",32400,400);
        addDensityConfig("enriched_naquadah_trinium_europium_duranide",34000,200);
        ...
        addDensityConfig("infinity_matter",82000,3400);
        ...
        addDensityConfig("lumium",4300,129);
        addDensityConfig("magnalium",1900,962);
        addDensityConfig("manganese",7430,480);
        addDensityConfig("molybdenum",10280,250);
        addDensityConfig("naquadah",32500,450);
        addDensityConfig("naquadah_alloy",32100,390);
        ...
        addDensityConfig("red_alloy",4000,300);
        ...
        addDensityConfig("vibranium",2566,1600);
